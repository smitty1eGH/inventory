...
def item_detail(item_id):
    email = flask.session.get("email")
    params = {"user_email": email, "item_id": item_id}
...
def items_delete():
    email = flask.session.get("email")
    params = {"user_email": email, "item_id": flask.request.form.get("item_id")}
...
def orders_add_item():
    ...
    return flask.redirect(
        flask.url_for("order_detail", order_id=flask.request.form.get("order_id"))
    )
...
def orders_delete():
    email = flask.session.get("email")
    params = {"order_id": flask.request.form.get("order_id"), "user_email": email}
...
def orders_delete_item():
    ...
    return flask.redirect(
        flask.url_for("order_detail", order_id=params.get("order_id"))
    )
...
def sales_add_item():
    ...
    return flask.redirect(
        flask.url_for("sale_detail", sale_id=flask.request.form.get("sale_id"))
    )
...
def sales_delete():
    email = flask.session.get("email")
    params = {"sale_id": flask.request.form.get("sale_id"), "user_email": email}
...
def samples_delete():
    email = flask.session.get("email")
    _get_db().delete_sample(
        {"user_email": email, "sample_id": flask.request.form.get("sample_id")}
    )
